...
constraint: "A cent is the wrong size for money you compute with. The error is a fraction of a penny, it enters the books as a fact, and nothing downstream ever raises a hand."
artifactLabel: "See one capture, in two assets →"
order: 2
description: "On a virtual-phone-number platform, the loss that mattered was not money taken twice. It was money written down wrong by a fraction of a cent, where nobody was looking."
---
