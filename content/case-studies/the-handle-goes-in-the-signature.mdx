...
I was the sole engineer on the backend of a workshop-management product: bookings, job cards, parts, labour, checksheets, and the record each of those leaves behind. It is twenty-nine feature modules now. Each one owns its tables and its rules.
