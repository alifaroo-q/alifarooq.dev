...
order: 3
description: "A transaction handle can hide in the request or go into every signature. I wrote it into the signatures on a workshop-management backend, and I found out why two years later, by counting."
---
