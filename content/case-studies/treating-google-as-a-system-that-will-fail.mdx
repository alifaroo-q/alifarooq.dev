...
constraint: "A watch lapses after seven days. A token expires, a webhook drops, and none of it makes a noise. I had to make the automation notice its own blind spots before someone downstream asked why a lead had gone cold."
artifactLabel: "See the state diagram →"
order: 1
description: "Mail automation for a healthcare provider, where a bad day looked exactly like a quiet one. I built it to notice its own blind spots, and the renewal job turned out to run every day."
---
